...
class User3 {
    constructor(email, name) {
        this.email = email;
        this.name = name;
        this._courseCount = 1; //since its private we cannot access this outside of this class, but we can inside of the class.
        this.coursePayment = 10; // I explain the protected keyword in the "inherited" part down there
        this.city = "berlin";
    }
    get getAppleEmail() {
